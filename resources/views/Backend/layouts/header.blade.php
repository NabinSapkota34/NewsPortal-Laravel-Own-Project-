        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('recentnews.create') }}">Create</a></li>
						<li><a href="{{ route('recentnews') }}">All Recent News</a></li>
                    </ul>
                </li>
                <li>
                    <a href="{{ route('home') }}">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{ route('LatestArticles.create') }}">Create</a></li>
						<li><a href="{{ route('LatestArticles.index') }}">All Latest Articles</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
